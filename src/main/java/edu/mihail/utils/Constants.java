...
public final class Constants {
    ...
    public static final class Warlord {
        private Warlord(){}
        public static final int ATTACK = 4;
    ...
    public static final class Weapon {
        ...
        public static final int SWORD_DEFENCE = 0;
        public static final int SWORD_VAMPIRISM = 0;
        public static final int SWORD_HEAL_POWER = 0;

        public static final int SHIELD_HEALTH = 20;
        public static final int SHIELD_ATTACK = -1;
        public static final int SHIELD_DEFENCE = 2;
        public static final int SHIELD_VAMPIRISM = 0;
        public static final int SHIELD_HEAL_POWER = 0;
        ...
        public static final int GREAT_AXE_HEAL_POWER = 0;
        ...
        public static final int KATANA_HEAL_POWER = 0;

        public static final int MAGIC_WAND_HEALTH = 30;
        public static final int MAGIC_WAND_ATTACK = 3;
        public static final int MAGIC_WAND_DEFENCE = 0;
        public static final int MAGIC_WAND_VAMPIRISM = 0;
